...
dynamic_array *get_apartments__apartment_repository(void *self) {
    apartment_repository *ar = self;

    return call(ar->__db_context, get_apartments);
}

void add_apartment__apartment_repository(void *self, apartment *apartment) {
    apartment_repository *ar = self;
...
i_apartment_repository__vtable apartment_repository_vtable = {

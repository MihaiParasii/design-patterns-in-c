...
static void visit_apartment__tax_calculator_visitor(void *self, apartment *apt) {
...
static void visit_ground_house__tax_calculator_visitor(void *self, ground_house *gh) {
    tax_calculator_visitor *v =
        container_of(self, tax_calculator_visitor, i_property_visitor__iface);
...
static i_property_visitor__vtable tax_calculator_visitor_vtable = {
    .visit_apartment    = visit_apartment__tax_calculator_visitor,
    .visit_ground_house = visit_ground_house__tax_calculator_visitor,
};

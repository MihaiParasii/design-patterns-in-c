...
int _get_rooms_count__base_house(void *self) {
    const base_house *s = container_of(self, base_house, i_house_component__iface);
...
base_house *_new__base_house0(void) {
    ...
    bh->i_house_component__iface.vtable = &house_component_vtable__base_house;
...
base_house *_new__base_house1_base_house(base_house *bh) {
    ...
    new_bh->i_house_component__iface.vtable = &house_component_vtable__base_house;
